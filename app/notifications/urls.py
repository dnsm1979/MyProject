...
from .views import CreateNotCommRepView, CreateNotificationView, NotificationCountView, DeleteNotificationView, ClearAllNotificationsView, MarkNotificationReadView

app_name = 'notifications'

urlpatterns = [
    path('create_notification/<int:pk>', CreateNotificationView.as_view(), name='create_notification'),
    path('reply_notification/<int:pk>', CreateNotCommRepView.as_view(), name='reply_notification'),
